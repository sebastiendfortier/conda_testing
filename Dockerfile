...
RUN mamba create -q -y -n fstd2nc-tester python=3.9 dask xarray netcdf4 hdf5 fortiers::eccc_rpnpy
...
RUN mamba create -q -y -n spookipy-tester python=3.9 fortiers::fstpy
